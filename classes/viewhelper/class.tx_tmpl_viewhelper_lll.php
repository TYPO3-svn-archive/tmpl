...
require_once $GLOBALS['PATH_tmpl'] . 'classes/exceptions/class.tx_tmpl_languagefileunavailableexception.php';
 ...
 * @subpackage tmpl
 */
class tx_tmpl_viewhelper_Lll implements tx_tmpl_ViewHelper {
	...
	/**
	 * constructor for class tx_tmpl_LllViewHelper
	 */
	public function __construct(array $arguments = array()) {

		if (!isset($arguments['languageFile'])) {
			throw new tx_tmpl_LanguageFileUnavailableException(
	...
	protected function loadLL() {
		$configuration = $GLOBALS['TSFE']->tmpl->setup['plugin.']['tx_tmpl.'];
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/tmpl/classes/viewhelper/class.tx_tmpl_viewhelper_lll.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/tmpl/classes/viewhelper/class.tx_tmpl_viewhelper_lll.php']);
}
